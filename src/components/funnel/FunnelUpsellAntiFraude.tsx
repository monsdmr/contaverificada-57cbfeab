    ...
    <div className="fixed inset-0 z-[80] bg-[#F0F2F5] overflow-y-auto pt-6">
      ...
      <main className="px-3 py-4 max-w-lg mx-auto pb-24">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm">
          ...
          <div className="bg-gray-50 rounded-lg p-3 mb-2 border border-gray-100"><div className="flex justify-between items-center mb-1"><span className="text-gray-500 text-[11px]">Tarifa anti-fraude:</span><span className="text-gray-900 text-sm font-bold">R$ 66,13</span></div><div className="flex justify-between items-center"><span className="text-gray-500 text-[11px]">Reembolso:</span><span className="text-[#00A651] text-[11px] font-semibold">Automático em até 2 min</span></div></div>
