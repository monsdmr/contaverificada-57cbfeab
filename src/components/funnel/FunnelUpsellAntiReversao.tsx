    ...
    <div className="fixed inset-0 z-[80] bg-[#F0F2F5] overflow-y-auto pt-6">
      ...
      <main className="px-3 py-4 max-w-lg mx-auto pb-24">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm mb-3">
          ...
          <div className="bg-gray-50 rounded-lg p-3 mb-4 border border-gray-100"><div className="flex items-center justify-between mb-1"><span className="text-gray-500 text-[11px]">Taxa de proteção:</span><span className="text-gray-900 text-sm font-bold">R$ 23,41</span></div><div className="flex items-center justify-between"><span className="text-gray-500 text-[11px]">Reembolso automático:</span><span className="text-green-600 text-[11px] font-bold">✓ Em até 2 min</span></div></div>
