...
const FunnelAntiFraudePaymentPage = () => {
  const [isCopied, setIsCopied] = useState(false);
  const [isChecking, setIsChecking] = useState(false);
  const [checkError, setCheckError] = useState<string | null>(null);

  const mockPixData = {
    transaction_id: "mock-antifraude-321",
    pix_code: "00020126580014br.gov.bcb.pix0136a1b2c3d4-e5f6-7890-abcd-ef1234567890520400005303986540526.905802BR5925USUARIO TESTE6009SAO PAULO62140510mock321654630456E2",
    pix_qr_code_base64: "",
    amount: 26.81,
    status: "pending",
  };
...
export default FunnelAntiFraudePaymentPage;
